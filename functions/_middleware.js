...
export async function onRequest(context) {
    ...
    if (request.method === "POST" && url.pathname === '/webhook') {
        try {
            ...
            // ================================================================
            // 🚨 Public User Bot Access Control - Group Bot Method (အတိကျ) 🚨
            // ================================================================
            if (!botKeyValue) {
...
Bot Key ကို မှန်ကန်စွာ သတ်မှတ်ထားခြင်း မရှိပါ။ ကျေးဇူးပြု၍ Bot Owner ကို ဆက်သွယ်ပါ။
            ...
            // ✅ Group Bot Method အတိုင်း - Response ကို JSON မသုံးဘဲ status ကိုပဲ စစ်တယ်
            try {
                ...
                // ✅ Group Bot လိုပဲ response.ok ကိုပဲ စစ်တယ်
...
အသေးစိတ်သိရှိလိုပါက Bot Owner ကို ဆက်သွယ်နိူင်ပါသည်။
                ...
                // ✅ Group Bot လိုပဲ အောင်မြင်ကြောင်း log ထုတ်တယ်
                console.log(`[onRequest] Public User Bot key ${botKeyValue} validated by Control Bot.`);
                
            } catch (validationError) {
                // ✅ Group Bot လိုပဲ Network Error ဖြစ်ရင် Deny လုပ်တယ်
